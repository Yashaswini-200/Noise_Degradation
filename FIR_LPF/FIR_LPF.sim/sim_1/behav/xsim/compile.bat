...
REM
REM Generated by Vivado on Tue Jun 30 17:22:19 +0530 2026
...
echo "xvlog --incr --relax -prj tb_fir_top_vlog.prj"
call xvlog  --incr --relax -prj tb_fir_top_vlog.prj -log xvlog.log
